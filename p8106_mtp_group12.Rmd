...
#x_2 = day %>% 
 # select(season, weekday, holiday, workingday, weathersit, temp, atemp, hum, windspeed)
#x_2 = model.matrix(~., x_2)
#gam.fit <-train(x_2, y,method = "gam",tuneGrid =data.frame(method = "GCV.Cp", select =c(TRUE,FALSE)),trControl = ctrl1)
